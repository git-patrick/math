...
namespace math {
	...
	template <typename X>
	using cos = typename _cos<X>::type;
	
	template <typename X>
	using acos = typename _acos<X>::type;
	...
	template <typename X>
	using sin = typename _sin<X>::type;
	
	template <typename X>
	using asin = typename _asin<X>::type;
	...
	template <typename X>
	using tan = typename _tan<X>::type;
	
	template <typename X>
	using atan = typename _atan<X>::type;
